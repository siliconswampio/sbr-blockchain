...
`npm install --save https://github.com/siliconswampio/sbr-blockchain.git`
...
**WARNING**: Since `@sbr/blockchain` is also doing write operations on the DB for safety reasons only run this on a copy of your database, otherwise this might lead to a compromised DB state.
