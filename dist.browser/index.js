...
var ethash_1 = __importDefault(require("@sbr/ethash"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.dbManager.numberToHash(new sbr_util_1.BN(0))];
                    case 1:
                    ...
                    case 4:
                        ...
                        dbOps_1 = [];
                        dbOps_1.push(helpers_1.DBSetTD(genesisBlock.header.difficulty.clone(), new sbr_util_1.BN(0), genesisHash));
                        helpers_1.DBSetBlockOrHeader(genesisBlock).map(function (op) { return dbOps_1.push(op); });
                        helpers_1.DBSaveLookups(genesisHash, new sbr_util_1.BN(0)).map(function (op) { return dbOps_1.push(op); });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _loop_1 = function (round) {
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        lastEpochBlockNumber = header.number.sub(header.number.mod(new sbr_util_1.BN(this_1._common.consensusConfig().epoch)));
                    ...
                    case 4:
                        ...
                        lastBlockNumber = (_a = blockSigners[blockSigners.length - 1]) === null || _a === void 0 ? void 0 : _a[0];
                        if (lastBlockNumber) {
                            lastEpochBlockNumber = lastBlockNumber.sub(lastBlockNumber.mod(new sbr_util_1.BN(this._common.consensusConfig().epoch)));
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        currentTd = { header: new sbr_util_1.BN(0), block: new sbr_util_1.BN(0) };
                                        dbOps = [];
